...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="container">
                <form action="/ubah_profil_detail/<?= $userdata['id']; ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="mt-4">
                        <a href="<?= base_url('user/detail/' . $userdata['id']); ?>" class="btn btn-danger">Kembali</a>
